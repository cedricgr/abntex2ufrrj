%% modelo-trabalho-academico.tex, v-1.1.0 Cedric Graebin
%%
...
% \usepackage{lineno}			% para linhas numeradas (bom para revisão com orientadores)

% configurações para a UFRRJ
\usepackage[versao=banca]{abntex2ufrrj}
...
% ----------------------------------------------------------
\pretextual							% equivalente ao \mainmatter do pacote Memoir
